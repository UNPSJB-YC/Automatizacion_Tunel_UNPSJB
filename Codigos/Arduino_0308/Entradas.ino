...
void salidas() {
  digitalWrite(3,RUNSTOP);  //señal de on off
  digitalWrite(4,Encendido);   //Habilito control por Ai1
  digitalWrite(Fallaext,FallaExterna); //señal que ocurrió una falla
  digitalWrite(6,Resetfalla); //señal para reset de fallas
}
